...
| `data-spreadsheet-active` on budget editor cells | Cell #1 — still gated on `budget-editor.tsx` shipping the attribute; flips independently of the rest. |
