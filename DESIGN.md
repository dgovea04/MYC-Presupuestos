...
4. Remove the cell's row from the checklist table once flipped (this section shrinks to 1 row for cell #3 today, and will shrink to 0 rows once the polynomial seed extension lands).
