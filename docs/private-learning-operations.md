...
Las métricas disponibles son agregadas (`activeExamples`, `revokedExamples`, `expiredExamples` y `usages`) y no incluyen payloads, descripciones completas ni datos personales.
