...
export async function GET(request: Request) {
  ...
  try {
    ...
    return knowledgeRouteErrorResponse(error, "No se pudieron consultar las partidas");
  }
}
...
export async function POST(request: Request) {
  ...
  } catch (error) { return knowledgeRouteErrorResponse(error, "No se pudo crear la partida"); }
}
