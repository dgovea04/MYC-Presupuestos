...
const { requireAdminSession, createKnowledgeRegion, listKnowledgeRegions } = vi.hoisted(() => ({ requireAdminSession: vi.fn(), createKnowledgeRegion: vi.fn(), listKnowledgeRegions: vi.fn() }));
