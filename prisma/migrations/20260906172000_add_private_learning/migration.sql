...
ALTER TABLE "private_learning_examples" ADD CONSTRAINT "private_learning_examples_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "private_learning_examples" ADD CONSTRAINT "private_learning_examples_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "private_learning_usages" ADD CONSTRAINT "private_learning_usages_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "private_learning_usages" ADD CONSTRAINT "private_learning_usages_budgetId_fkey" FOREIGN KEY ("budgetId") REFERENCES "budgets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
