...
function DocumentRow({ document, selected, onToggle, onClassified, onReplace, onDelete }: { document: ReviewDocumentView; selected: boolean; onToggle: () => void; onClassified: () => void; onReplace: () => void; onDelete: () => void }) {
