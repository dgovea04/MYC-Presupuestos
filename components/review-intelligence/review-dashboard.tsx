  ...
  return (
    <Card className="theme-surface-card" data-testid="review-dashboard">
      ...
      <CardContent className="space-y-5">
        ...
        {coverageByCategory ? <section aria-label="Cobertura por categoría" className="rounded-xl border border-[var(--app-border)] bg-[var(--app-surface-muted)] p-3"><h4 className="text-sm font-semibold text-[var(--app-text-strong)]">Cobertura por categoría</h4><dl className="mt-2 grid gap-2 text-sm sm:grid-cols-2"><Coverage label="Metrados" value={coverageByCategory.quantity} /><Coverage label="Especificaciones" value={coverageByCategory.specification} /><Coverage label="APU" value={coverageByCategory.apuComponent} /><Coverage label="Rendimientos" value={coverageByCategory.yield} /></dl></section> : null}
