...
type Credential = { id: string; provider: string; maskedValue: string; status: string; isFallback: boolean; lastError: string | null; health?: string };
