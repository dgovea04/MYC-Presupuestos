...
export const SPECIALIST_BUNDLES: SpecialistBundle[] = [
  ...
  },
  {
    ...
    systemPrompt: [
      ...
      "Antes de crear un presupuesto, pide al usuario: nombre, tipo de obra y ubicación.",
...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    initialGoal: "Crear un proyecto de construcción con su presupuesto. Primero usa searchCompanies para listar las empresas del usuario, luego createProject para crear el proyecto con su Presupuesto General y sub-presupuestos automáticos. Después agrega capítulos y partidas según el tipo de obra.",
    defaultMode: "goal",
  },
  {
  ...
  },
  {
    ...
    bundleSlug: "budget-agent",
    initialGoal: "Crear un proyecto de construcción desde cero. Primero usa searchCompanies para listar las empresas del usuario, luego createProject para crear el proyecto con su Presupuesto General y sub-presupuestos automáticos. El objetivo es solo crear el proyecto y su estructura base, sin agregar capítulos, partidas ni APUs adicionales.",
    defaultMode: "goal",
  },
  {
    ...
    initialGoal: "Ayuda general con la plataforma. Puedes crear proyectos usando searchCompanies y createProject, gestionar presupuestos, partidas, APU, insumos, cronogramas, metrados o reportes del proyecto actual.",
    defaultMode: "chat",
  },
];
