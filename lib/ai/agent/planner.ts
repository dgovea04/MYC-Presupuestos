...
const KEYWORD_TOOLS: Array<{
  ...
  {
    keywords: ["cronograma", "programación", "schedule", "generar cronograma", "crear cronograma"],
  ...
  {
    keywords: ["previsualizar cronograma", "vista previa cronograma", "preview cronograma", "ver cronograma antes", "simular cronograma"],
    toolName: "previewSchedule",
    title: "Previsualizar cronograma",
    objective: "Generar vista previa del cronograma sin escribir en la base de datos.",
    expectedOutcome: "Resumen de partidas programadas, fechas estimadas, issues y estrategia.",
    isWrite: false,
    approvalBoundary: false,
  },
  {
    keywords: ["ruta crítica", "critical path", "calcular ruta", "ruta critica", "holgura", "camino crítico"],
    toolName: "calculateCriticalPath",
    title: "Calcular ruta crítica",
    objective: "Calcular la ruta crítica del cronograma: tareas críticas, holguras y duración total.",
    expectedOutcome: "Lista de tareas críticas con holgura cero y duración total del proyecto.",
    isWrite: false,
    approvalBoundary: false,
  },
  {
  ...
  {
    keywords: ["preview presupuesto", "vista previa", "previsualiza", "previsualizar presupuesto", "generar presupuesto", "crear presupuesto con partidas", "presupuesto automatico"],
    toolName: "previewBudgetGeneration",
    title: "Previsualizar generación de presupuesto",
    objective: "Generar vista previa del presupuesto antes de escribir en la base de datos.",
    expectedOutcome: "Preview con fuente recomendada, subpresupuestos, partidas y advertencias.",
    isWrite: false,
    approvalBoundary: false,
  },
  {
    ...
    title: "Aplicar generación de presupuesto",
    objective: "Ejecutar la generación de presupuesto previamente previsualizada.",
    expectedOutcome: "Presupuesto generado con partidas en la base de datos.",
    isWrite: true,
    approvalBoundary: true,
  },
  {
    ...
    objective: "Crear un Presupuesto General con sub-presupuestos automáticos.",
    expectedOutcome: "Presupuesto General creado con estructura base de sub-presupuestos.",
    isWrite: true,
    approvalBoundary: true,
  },
  {
    ...
    objective: "Crear un sub-presupuesto bajo un Presupuesto General existente.",
    expectedOutcome: "Sub-presupuesto creado heredando tasas del padre.",
    isWrite: true,
    approvalBoundary: true,
  },
  {
    ...
    objective: "Buscar paquetes .mcp que coincidan con la descripción del usuario.",
    expectedOutcome: "Lista de paquetes .mcp con scores de similitud.",
    isWrite: false,
    approvalBoundary: false,
  },
];
