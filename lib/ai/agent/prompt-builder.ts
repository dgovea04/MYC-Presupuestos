...
export function buildProjectNamedFlow(projectName: string, projectId: string): string {
  return [
    ...
    "",
    "⛔ DESPUÉS DE GENERAR: Cuando generateBudget termine exitosamente, MUESTRA un breve resumen de lo generado y DETENTE. NO llames calculateBudget, searchBudgets ni ninguna otra herramienta. El presupuesto ya está creado. Solo informa al usuario y espera.",
    "",
    "REGLAS IMPORTANTES:",
