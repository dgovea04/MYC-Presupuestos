...
export async function getAiUsageReport(filters: AiUsageReportFilters = {}) {
  ...
  const [summary, byWorkspace, byProvider, bySource, byTask, byProject, byTeam, failures] = await Promise.all([
